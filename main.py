...
class MiMotion():
   ...
   #发送酷推
    ...
    def main(self):
        ...
        # ---------- 2. 计算步数范围 ----------
        try:
            min_step = math.ceil(int(self.check_item.get("min_step", 10001)) * step_ratio)
        ...
        try:
            ...
            data_json = data_json.replace('2025-08-17', today).replace('17760', '13511')
